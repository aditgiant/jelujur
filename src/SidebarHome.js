        ...
        <div id="flyoutMenu"
           className={visibility}>
            ...
            {(collectionsexpand==="expanded") && <div id="flyoutMenu-page">
              ...
              <Link style={{ textDecoration: 'none' }} to='/collections/ss2020' onClick={this.handleMouseDownCollections2}><div className="flyoutMenu-item subflyoutMenu"><h3>Spring-Summer 2020</h3><h3 id="flyoutArrow">&gt;&nbsp;</h3></div></Link>
            </div>}
      </div>
      </div>
    );
